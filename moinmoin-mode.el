...
;;
;; $Lastupdate: 2017-09-13 18:10:03$
;; Copyright (C) ASK
;; Copyright (C) 2017 Youhei SASAKI <uwabami@gfd-dennou.org>
;;
;; Author: ASK
;; URL: http://moinmo.in/EmacsForMoinMoin/MoinMoinMode?action=raw
;; Version: 20170913
...
;;   @see http://moinmo.in/EmacsForMoinMoin/MoinMoinMode?action=raw
;; Changed:
;; - remove screen-lines, use longline-mode
;; - Update font-lock-mode, make buffer-local
